...
internal class PermissionStep : OnboardingStep {
    ...
    override fun Content() {
        ...
        Column {
            ...
            // MihonSY: crash reporting / analytics toggles commented out from the UI.
            // The preferences and PermissionSwitch composable stay in the code, they are
            // just not offered to the user anymore (never displayed, never toggled).
            //
            // HorizontalDivider(
